# Simulado Completo 2 — AIF-C01

Segundo simulado com ênfase em leitura arquitetural e tomada de decisão orientada por serviços AWS.

**1.** Uma aplicação generativa lida com decisões sensíveis de RH. Qual prática é mais alinhada com IA responsável?
...
**2.** Qual serviço ajuda a identificar PII em dados armazenados no S3?
...
**3.** Qual escolha tende a ser melhor quando a empresa quer reduzir custo ocioso em inferência esporádica?
...
**4.** Qual serviço é o mais indicado para recomendação personalizada de produtos?
...
**5.** Se a pergunta fala em simplicidade operacional para usar FMs por API, qual serviço AWS costuma ser a melhor resposta?
...
**6.** Uma empresa quer responder perguntas sobre políticas internas usando documentos atualizados com frequência. Qual solução é mais coerente?
...
**7.** Qual serviço AWS é mais alinhado à construção de um modelo customizado com dados próprios?
...
**8.** Qual recurso ajuda a aplicar políticas de conteúdo em aplicações generativas no Bedrock?
...
**9.** Em uma arquitetura RAG, qual elemento existe para recuperar contexto semântico?
...
**10.** Qual serviço AWS é mais indicado para extrair texto, formulários e tabelas de PDFs?
